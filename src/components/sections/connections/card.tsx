...
export function FeatureCard({
    ...
    return (
        <Card className="w-[18.5625rem] md:w-[24.1875rem] px-8 py-8 md:pb-[2.625rem] gap-12 shadow-none border-[#3E4F64] rounded-[2.5rem]">
            ...
            <CardContent className="px-0 min-h-[9.4375rem] md:min-h-[6.75rem]">
